...
from src.apps.auto_system.views.test_suite import TestSuiteSerializers, TestSuiteSerializersC
from src.common.enums.tools_enum import StatusEnum, TaskEnum, TestCaseTypeEnum
...
class TestSuiteDetailsCRUD(ModelCRUD):
    ...
    def get(self, request: Request):
        ...
        TestSuiteDetailResultService.attach_children(data_list)
...
class TestSuiteDetailsViews(ViewSet):
    ...
    def get_all_retry(self, request: Request):
        ...
        detail_ids = list(test_suite_details.values_list('id', flat=True))
        for i in test_suite_details:
            ...
            i.fail = 0
            i.save()
        TestSuiteDetailResultService.clear_result(detail_ids)
    ...
    def get_retry(self, request: Request):
        ...
        TestSuiteDetailResultService.clear_result([test_suite_details.id])
