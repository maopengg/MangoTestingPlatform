...
from src.apps.auto_system.service.menu import ad_routes
from src.apps.auto_user.models import User
from src.apps.auto_user.views.role import RoleSerializers
from src.common.enums.system_enum import ClientTypeEnum
from src.common.middleware.utlis.jwt_auth import create_token
