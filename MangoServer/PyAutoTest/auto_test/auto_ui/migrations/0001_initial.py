    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_name', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                to='auto_system.timetasks')),
                ('timing_actuator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auto_ui.uicase')),
                ('el_name', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                              related_name='related_UiElement_a', to='auto_ui.uielement')),
                ('el_name_b', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
