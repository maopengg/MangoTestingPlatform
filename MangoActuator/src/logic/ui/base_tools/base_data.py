...
from src.enums import UiPublicTypeEnum
...
from src.tools import DataProcessor
from src.tools import MysqlConnect
from src.tools import ERROR_MSG_0036, ERROR_MSG_0038
...
class BaseData:
    ...
    def __init__(self, project_product_id, driver_object) -> None:
        ...
        from src.logic.ui.base_tools.driver_object import DriverObject
