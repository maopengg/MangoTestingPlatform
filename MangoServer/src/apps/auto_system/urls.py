...
from src.apps.auto_system.views.time_tasks import TimeTasksCRUD, TimeTasksViews
...
from src.apps.task_center.views.schedule_fire import ScheduleFireCRUD
from src.apps.task_center.views.system_job import SystemJobViews
...
urlpatterns = [
    ...
    path('tasks/fire-record', ScheduleFireCRUD.as_view()),
    path('tasks/system/jobs', SystemJobViews.as_view({'get': 'list'})),
    path('tasks/system/jobs/trigger', SystemJobViews.as_view({'post': 'trigger'})),
    #
