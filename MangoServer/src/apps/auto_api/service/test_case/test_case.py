...
from src.apps.auto_api.models import ApiCaseDetailed, ApiCase, ApiInfo, ApiCaseDetailedParameter
...
from src.common.models.api_model import RequestModel, ApiCaseResultModel, ApiCaseStepsResultModel, ResponseModel
...
class TestCase:
    ...
    def __init__(self,
        ...
        self.test_setup = APIBaseTestSetup(db_context=db_context)
        try:
