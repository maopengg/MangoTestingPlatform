...
ERROR_MSG_0016 = (316, '合并代码失败，请手动处理~')
ERROR_MSG_0017 = (317, '拉取代码失败')
ERROR_MSG_0018 = (318, '不是有效的git地址，如果确认地址有效则联系管理员！')
ERROR_MSG_0019 = (319, '')
ERROR_MSG_0020 = (320, '')
...
ERROR_MSG_0027 = (327, '您要设置的用户open状态失败，可能用户没有登录执行器，请先登录之后再进行设置状态')
