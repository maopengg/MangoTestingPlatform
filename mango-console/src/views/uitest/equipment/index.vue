            ...
            <template #columns>
              ...
              >
                ...
                <template v-else-if="item.key === 'web_type'" #cell="{ record }">
                  <a-tag color="green" size="small" v-if="record.config?.web_type === 0">谷歌浏览器</a-tag>
                  <a-tag color="red" size="small" v-else-if="record.config?.web_type === 1">EDGE</a-tag>
                  <a-tag color="red" size="small" v-else-if="record.config?.web_type === 2">火狐</a-tag>
                  <a-tag color="red" size="small" v-else-if="record.config?.web_type === 3">WEBKIT</a-tag>
                </template>
            ...
            >
              ...
              <template v-else-if="item.type === 'select' && item.key === 'web_parallel'">
                <a-select
                    v-model="item.value"
                    :placeholder="item.placeholder"
                    :options="[{ value: 1, label: '1' },{ value: 2, label: '2' },{ value: 3, label: '3' },{ value: 5, label: '5' },{ value: 10, label: '10' },{ value: 15, label: '15' },{ value: 20, label: '20' },{ value: 30, label: '30' }]"
                    value-key="key"
                    allow-clear
                    allow-search
                />
