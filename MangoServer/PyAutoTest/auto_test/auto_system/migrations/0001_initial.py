    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_message', models.CharField(max_length=64, null=True, verbose_name='错误提示')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ui_case', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auto_ui.uicase')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(null=True, verbose_name='是否启用')),
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auto_user.project')),
