  ...
  <a-popover v-model:visible="visible" trigger="click">
    <template #content>
      <div class="icon-container">
        <a-input-search placeholder="搜索图标名称" press-enter style="width: 100%" @search="onSearch" allowClear search-button />
        <div class="mt-4"></div>
        ...
        <div class="mt-1"></div>
        <a-pagination size="mini" :pageSize="pageSize" :total="total" :show-size-changer="false" @change="onPageChange" />
      </div>
    </template>
