...
if IS_MINIO:
    MINIO_STORAGE_ENDPOINT = 'minio.internal:9000'  # 访问IP+端口
    ...
    MINIO_STORAGE_ACCESS_KEY = 'DS2hi1L4MG3EABBl6Q8S'  # ACCESS_KEY
    MINIO_STORAGE_SECRET_KEY = 'VhHkFbk8Vg1hDzeKlXYCWpCHx6063gMCqrBdeBim'  # SECRET_KEY
