...
from src.auto_test.auto_data_factory.models import DataFactoryExecutionItem
from src.auto_test.auto_data_factory.views.execution import DataFactoryExecutionSerializerC
...
class DataFactoryExecutionItemSerializerC(serializers.ModelSerializer):
    ...
    def setup_eager_loading(queryset):
        return queryset.select_related(
            ...
            'execution__test_object',
            'execution__test_object__project_product',
            'execution__test_object__executor_name',
            'execution__template',
            'template',
