...
from src.apps.auto_api.models import ApiCaseDetailedParameter, ApiInfo, ApiHeaders
...
from src.apps.auto_ui.models import UiCase, PageElement, Page, PageSteps
from src.apps.auto_user.models import UserLogs, User
