...
class PytestActCRUD(ModelCRUD):
    model = PytestAct
    queryset = PytestAct.objects.all()
    serializer_class = PytestActSerializersC
    serializer = PytestActSerializers


class PytestActViews(ViewSet):
    model = PytestAct
