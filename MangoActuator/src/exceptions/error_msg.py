...
# @Author : 毛鹏
ERROR_MSG_0001 = (301, '登录失败，请检查输入的域名是否正确！请求url:{},响应：{}')
ERROR_MSG_0002 = (302, 'minio没有进行配置，所以无法测试上传文件的用例')
ERROR_MSG_0003 = (303, 'minio下载文件失败，请检查配置是否正确')
ERROR_MSG_0004 = (304, 'minio下载文件失败，请检查文件名称是否正确，现在的文件名称：{}')
ERROR_MSG_0005 = (305, '')
ERROR_MSG_0006 = (306, '')
