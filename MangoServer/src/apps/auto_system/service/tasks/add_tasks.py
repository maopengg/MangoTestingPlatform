...
from src.common.enums.tools_enum import TaskEnum, TestCaseTypeEnum, StatusEnum
from src.common.tools.view import Snowflake
...
class AddTasks:
    ...
    def add_test_suite(self):
        from src.apps.auto_system.views.test_suite import TestSuiteCRUD
    ...
    def add_test_suite_details(self, case_id: int, _type: TestCaseTypeEnum):
        def set_task(case_id, case_name, project_product, case_sum, parametrize=None):
            from src.apps.auto_system.views.test_suite_details import TestSuiteDetailsCRUD
