...
class SettingPage(QWidget):
    def __init__(self, parent):
        ...
        input_2_1 = MangoLineEdit('请输入请求超时时间', )
        ...
        card_widget3 = MangoCard(card_layout3, '邮箱配置')
        input_1 = MangoLineEdit('请输入邮箱发送人-不可用', )
        card_layout3.addRow('邮箱发送人', input_1)
        input_2 = MangoLineEdit('请输入邮箱域名-不可用', )
        card_layout3.addRow('邮箱域名', input_2)
        input_3 = MangoLineEdit('请输入邮箱的stamp_key-不可用', )
        card_layout3.addRow('邮箱stamp_key', input_3)

        card_layout4 = MangoFormLayout()
        card_widget4 = MangoCard(card_layout4, '服务域名')
        self.input_4_1 = MangoLineEdit('请输入请求超时时间-不可用', )
        card_layout4.addRow('服务域名', self.input_4_1)
