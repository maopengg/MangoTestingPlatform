...
from src.apps.auto_system.models import TestObject, Project, ProjectProduct, ProductModule
from src.common.enums.tools_enum import StatusEnum, EnvironmentEnum
