...
from src.apps.auto_system.models import Tasks, TasksDetails, TimeTasks
...
from src.common.tools.database.mysql_lock import acquire_mysql_lock, release_mysql_lock
