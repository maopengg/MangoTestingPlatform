...
class WhatIsEqualToAssertion:
    ...
    def p_is_equal_to(value, expect):
        ...
        # print(f'元素文本：{value}，断言元素等于：{expect}， 断言结果：成功')
    ...
    @staticmethod
    def p_sum_equal_expect(sum_: list, expect):
        """长度等于expect"""
        assert_that(sum(sum_)).is_equal_to(expect)


if __name__ == '__main__':
    WhatIsEqualToAssertion.p_sum_equal_expect([1, 2, 3], 6)
