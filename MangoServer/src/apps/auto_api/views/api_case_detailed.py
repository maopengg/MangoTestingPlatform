...
from src.apps.auto_api.models import ApiCaseDetailed, ApiInfo, ApiCase, ApiCaseDetailedParameter
from src.apps.auto_api.views.api_case import ApiCaseSerializers
from src.apps.auto_api.views.api_info import ApiInfoSerializers
...
class ApiCaseDetailedCRUD(ModelCRUD):
    ...
    def callback(self, _id):
        ...
        from src.apps.auto_api.views.api_case import ApiCaseCRUD
