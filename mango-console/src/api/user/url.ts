...
export const userProductName = '/user/product/name'
export const userProductAllModuleName = '/user/product/all/module/name'
export const userModule = '/user/module'
export const userTestObjName = '/user/project/environment/name'
export const userTestObject = '/user/test/object'
export const userTestObjectName = '/user/test/object/name'
export const userTestObjectPutStatus = '/user/test/object/put/status'
export const userFile = '/user/file'
