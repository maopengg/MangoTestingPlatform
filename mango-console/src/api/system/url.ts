...
export const systemTestSuite = 'system/test/suite'
export const systemTestSuiteDetails = 'system/test/suite/details'
...
export const systemCacheValue = 'system/cache/value'
...
export const systemEnumProduct = 'system/enum/product'
export const systemEnumAutoType = 'system/enum/auto/type'
