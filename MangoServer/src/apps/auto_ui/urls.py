...
from src.apps.auto_ui.views.ui_case import UiCaseCRUD, UiCaseViews
from src.apps.auto_ui.views.ui_case_steps_detailed import UiCaseStepsDetailedCRUD, UiCaseStepsDetailedViews
from src.apps.auto_ui.views.ui_element import PageElementCRUD, PageElementViews
from src.apps.auto_ui.views.ui_page import PageCRUD, PageViews
from src.apps.auto_ui.views.ui_page_steps import PageStepsCRUD, PageStepsViews
from src.apps.auto_ui.views.ui_page_steps_detailed import PageStepsDetailedCRUD, PageStepsDetailedView
from src.apps.auto_ui.views.ui_public import UiPublicCRUD, UiPublicViews
