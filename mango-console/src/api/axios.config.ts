...
export const baseURL = 'http://10.32.90.9:8000'
// export const baseURL = 'http://172.10.0.193:8000'
export const webSocketURL = 'ws://10.32.90.9:8000/web/socket?'
// export const webSocketURL = 'ws://172.10.0.193:8000/web/socket?'
