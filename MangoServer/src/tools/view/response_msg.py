...
# AI写用例模块
RESPONSE_MSG_0158 = (200, '获取需求名称列表成功')
RESPONSE_MSG_0159 = (200, 'AI分析任务已启动，请稍后刷新查看结果')
RESPONSE_MSG_0160 = (200, 'AI测试点生成任务已启动，请稍后刷新查看结果')
RESPONSE_MSG_0161 = (200, 'AI用例生成任务已启动，请稍后刷新查看结果')
RESPONSE_MSG_0162 = (200, '需求拆分确认状态更新成功')
RESPONSE_MSG_0163 = (200, '测试点确认状态更新成功')
