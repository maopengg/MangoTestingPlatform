    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_step',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auto_ui.pagesteps')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ele_name',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auto_ui.pageelement')),
                ('page_step',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='auto_ui.pagesteps')),
            ],
            options={
